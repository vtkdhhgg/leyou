...
public class AuthController {
     ...
     *  无须给前段浏览器返回token，token只有后端才需要使用，并且将token保存到cookie中
     * @param username
     * @param password
     * @return
     */
    @PostMapping("login")
    public ResponseEntity<Void> queryUsernameAndPassword(
